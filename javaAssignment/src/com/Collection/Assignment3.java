...
public class Assignment3 {
	...
	public static void main(String[] args) {
		...
		ts.add(new Employee(5,"Anil","tech",36767.9));
		ts.add(new Employee(7,"Gani","FullStack",106767.9));
		ts.add(new Employee(3,"Suresh","GTS",66767.9));
		ts.add(new Employee(2,"Appu","FullStack",96767.9));
		ts.add(new Employee(4,"Anuska","AWS",86767.9));
		ts.add(new Employee(1,"Chanti","FullStack",46767.9));
		ts.add(new Employee(9,"sunil","FrontEnd",56787.9));
